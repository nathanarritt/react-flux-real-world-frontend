...
// Below is the source of the proxy-middleware plugin (v0.13.0). It doesn't
// support our use case out of the box so I had to modify it a little to work.
// This should probably be moved to our own version of the plugin or submitted
// to the original author as a pull request to see if he will include the changes.
var os = require('os');
